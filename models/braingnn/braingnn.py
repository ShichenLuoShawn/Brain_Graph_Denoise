...
from models.braingnn.braingraphconv import MyNNConv


##########################################################################################################################
class Network(torch.nn.Module):
    def __init__(self, indim, ratio, nclass, k=8, R=90):
        '''
        ...
        self.fc2 = torch.nn.Linear(self.dim2, 128)
    ...
    def forward(self, x, edge_index, batch, edge_attr, pos):
        ...
        pos = (pos.reshape(pos.shape[0]*pos.shape[1],-1)[perm]).reshape(pos.shape[0],-1,self.indim)
